    ...
    <tr>
     ...
     <tr>
      <td width="350" valign="top">
       <form action="/showedit/{{$data->pid}}" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
         <tr>
             {{csrf_field()}}
          <td><b>幻灯名称</b>
<input type="text" name="show_name" value="{{$data->show_name}}" size="20" class="inpMain" />
          </td>
         </tr>
         <tr>
          <td><b>幻灯图片</b>
         ...
         <tr>
          <td><b>链接地址</b>
           <input type="text" name="show_link" value="{{$data->show_link}}" size="40" class="inpMain" />
          </td>
         </tr>
         <tr>
          <td><b>排序</b>
