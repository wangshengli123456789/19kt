...
@section('content')
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加课程</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="/proindex" class="actionBtn">课程列表</a>添加课程</h3>
    <form action="{{url('proadd')}}" method="post" enctype="multipart/form-data">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">课程名称</td>
       <td>
        <input type="text" name="classname" value="" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td width="90" align="right">交流群组</td>
       <td>
        <input type="text" name="writegroup" value="" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td width="90" align="right">开始有效时间</td>
       <td>
        <input type="date" name="useful_time" value="" size="80" class="inpMain" />
        <input type="hidden" name="create_time" value="{{date("Y-m-d")}}" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td>
        <input type="text" name="old_price" value="" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td width="90" align="right">现价</td>
       <td>
        <input type="text" name="new_price" value="" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td>
        <select name="exam_type">
         @foreach($type as $k=>$v)
          <option value="{{$v->id}}">{{$v->exam_type1}}</option>
         @endforeach
        </select>
       </td>
      </tr>
